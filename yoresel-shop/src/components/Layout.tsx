...
import { FiSearch, FiUser, FiHeart, FiShoppingCart, FiChevronRight, FiTruck, FiAward, FiLock, FiInstagram, FiFacebook, FiYoutube, FiPhone, FiMail } from 'react-icons/fi'
import { FaPinterest, FaTiktok, FaYoutube, FaTwitter } from 'react-icons/fa'
