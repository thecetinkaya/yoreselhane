  ...
  return (
    <AccountLayout>
      ...
      <div className="bg-slate-50 p-4 text-sm text-slate-600 mb-6 rounded">
        Bu sayfadan sipariş iptali yapılmaktadır, mevcut taleplerinizin durumunu anlık olarak takip edebilirsiniz. Süreçle ilgili her adımda size e-posta veya SMS ile bilgi vereceğiz.
      </div>
      ...
      {isCreating ? (
        ...
        <div className="border border-slate-100 rounded-lg p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
          ...
          <h3 className="text-lg font-bold text-slate-800 mb-4">Geçmiş İptal Kaydı Bulunamadı</h3>
          <p className="text-slate-500 mb-8">
            Şu anda oluşturduğunuz iptal kaydı bulunmamaktadır.
          </p>
